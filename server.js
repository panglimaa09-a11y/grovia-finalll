...
app.get(['/user','/user/'],async(_req,res,next)=>{try{const file=await readFile(path.join(publicDir,'user','index.html'),'utf8');const cleaned=file.replace(/<script>let sb,session;[\s\S]*?<\/script>/,'');const injected='\n<script src="/user/api-stability.js?v=20260830-3"></script>\n<script src="/user/core-navigation.js?v=20260830-1"></script>\n<script src="/user/overview-recovery.js"></script>\n<script src="/user/youtube-connect.js"></script>\n<script src="/user/growth-id-fix.js?v=20260830-3"></script>\n<script src="/user/user-enhance.js"></script>\n<script src="/user/growth-layout-fix.js?v=20260830-3"></script>\n<script src="/user/analytics-ui.js"></script>\n<script src="/user/ai-content.js"></script>\n<script src="/user/content-editor.js"></script>\n<script src="/user/scheduler-ui.js?v=20260830-2"></script>\n<script src="/user/publisher-storage-compat.js?v=20260830-1"></script>\n<script src="/user/publisher-storage-compat-v2.js?v=20260830-1"></script>\n<script src="/user/publisher-ui-v2.js?v=20260830-8"></script>\n<script src="/user/growth-engine.js?v=20260830-4"></script>\n<script src="/user/growth-plan.js?v=20260830-3"></script>\n<script src="/user/reports-ui.js?v=20260830-2"></script>\n<script src="/user/page-modules.js?v=20260830-5"></script>\n';res.type('html').send(cleaned.replace('</body>',injected+'</body>'));}catch(e){next(e)}});
